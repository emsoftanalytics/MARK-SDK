...
# source credibility scoring, and automatic self-healing belong in MARK Cloud.
...
class WebSearchSkill(Skill):
    ...
    Cloud replacement: AdvancedWebSearchSkill adds LLM-guided browser lookup,
    source credibility scoring, result caching, and governed self-healing.
    """
    ...
    def manifest(cls) -> SkillManifest:
        ...
        return SkillManifest(
            ...
            install_hint="pip install mark[web]",
        )
